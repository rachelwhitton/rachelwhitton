(function($) {
	$(document).ready(function() {
		...
		function advent_add_file(event, selector) {
			...
			frame.on( 'select', function() {
				...
				selector.find('.remove-image, .remove-file').on('click', function() {
					advent_remove_file( $(this).parents('.section') );
				});
			});
		...
		function advent_remove_file(selector) {
			...
			selector.find('.upload-button').live('click', function() {
				advent_add_file(event, $(this).parents('.section'));
			});
		}
